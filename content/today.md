...
- VulDB Recent Entries
  ...
  - [CVE-2026-15142 | WebCodingPlace Real Estate Manager Pro Plugin up to 12.8.6 on WordPress allow_attachment_actions privileges management](https://vuldb.com/vuln/390421)
  ...
  - [CVE-2026-16142 | themetechmount TrueBooker Plugin up to 1.2.6 on WordPress AJAX add_front_user_update truebooker_wp_user_id password recovery](https://vuldb.com/vuln/390420)
  ...
  - [CVE-2026-72016 | Linux Kernel up to 6.18.39/7.1.4/7.2-rc2 cpu/hotplug fs/sysfs/group.c cpuhp_smt_enable initialization](https://vuldb.com/vuln/390446)
  - [CVE-2026-72017 | Linux Kernel up to 7.2-rc2 MACB driver macb_free_consistent tx_skb allocation of resources](https://vuldb.com/vuln/390439)
  - [CVE-2026-72018 | Linux Kernel up to 6.12.96/6.18.39/7.1.4/7.2-rc2 dibs move_data out-of-bounds write](https://vuldb.com/vuln/390432)
  - [CVE-2026-72019 | Linux Kernel up to 7.2-rc2 macsec macsec_encrypt out-of-bounds](https://vuldb.com/vuln/390429)
  - [CVE-2026-72020 | Linux Kernel up to 7.2-rc2 ipvs ip_vs_conn_new uninitialized variable](https://vuldb.com/vuln/390435)
  - [CVE-2026-72021 | Linux Kernel up to 7.2-rc2 ipvs set_sctp_state behavioral workflow](https://vuldb.com/vuln/390440)
  - [CVE-2026-72022 | Linux Kernel up to 7.2-rc2 llc llc_ui_autobind reference count](https://vuldb.com/vuln/390433)
  - [CVE-2026-72023 | Linux Kernel up to 7.2-rc2 octeontx2-pf otx2_init_hw_resources memory leak](https://vuldb.com/vuln/390434)
  - [CVE-2026-72024 | Linux Kernel up to 7.2-rc2 mac802154 ieee802154_wake_queue race condition](https://vuldb.com/vuln/390445)
  - [CVE-2026-72025 | Linux Kernel up to 7.2-rc1 s390/monwriter memory corruption](https://vuldb.com/vuln/390430)
  - [CVE-2026-72026 | Linux Kernel up to 6.12.96/6.18.39/7.1.4/7.2-rc1 irqchip irq-riscv-imsic-early.c imsic_early_acpi_init allocation of resources](https://vuldb.com/vuln/390436)
  - [CVE-2026-72028 | Linux Kernel up to 7.2-rc1 RISC-V Probes regs_get_kernel_stack_nth stack-based overflow](https://vuldb.com/vuln/390447)
  - [CVE-2026-72030 | Linux Kernel up to 7.2-rc1 libata-core ata_dev_config_cpr buffer overflow](https://vuldb.com/vuln/390437)
  - [CVE-2026-72031 | Linux Kernel up to 7.1.4/7.2-rc1 libata-core denial of service](https://vuldb.com/vuln/390441)
  - [CVE-2026-72032 | Linux Kernel up to 6.12.100/6.18.39/7.1.4/7.2-rc1 HWS net/mlx5 hws_bwc_matcher_move allocation of resources](https://vuldb.com/vuln/390442)
  - [CVE-2026-72033 | Linux Kernel up to 7.2-rc1 orangefs fill_from_part out-of-bounds](https://vuldb.com/vuln/390443)
  - [CVE-2026-72034 | Linux Kernel up to 6.12.96/6.18.39/7.1.4/7.2-rc1 fhandle capable_wrt_mount null pointer dereference](https://vuldb.com/vuln/390444)
  - [CVE-2026-72035 | Linux Kernel up to 7.2-rc1 sch_taprio net/sched/sch_taprio.c taprio_dequeue_from_txq null pointer dereference](https://vuldb.com/vuln/390438)
  - [CVE-2026-72036 | Linux Kernel up to 7.2-rc1 sch_multiq net/sched/sch_multiq.c multiq_dequeue null pointer dereference](https://vuldb.com/vuln/390449)
  - [CVE-2026-72037 | Linux Kernel up to 7.2-rc1 lan743x lan743x_hardware_init uninitialized resource](https://vuldb.com/vuln/390459)
  - [CVE-2026-72038 | Linux Kernel up to 7.2-rc1 liquidio cn23xx_get_pf_num memory leak](https://vuldb.com/vuln/390450)
  - [CVE-2026-72039 | Linux Kernel up to 7.1.4 bnx2x bnx2x_alloc_mem_bp memory leak](https://vuldb.com/vuln/390460)
  - [CVE-2026-72040 | Linux Kernel up to 6.6.147/6.12.100/6.18.39/7.1.4 ipmi i_ipmi_request supplied_recv reference count](https://vuldb.com/vuln/390451)
  - [CVE-2026-72041 | Linux Kernel up to 6.6.144/6.12.96/6.18.39/7.1.4 espintcp sk_msg_free_partial iteration](https://vuldb.com/vuln/390461)
  - [CVE-2026-72042 | Linux Kernel up to 6.18.39/7.1.4 ipmi handle_read_event_rsp use after free](https://vuldb.com/vuln/390452)
  - [CVE-2026-72043 | Linux Kernel up to 7.1.4 LoongArch pte_wrprotect input validation](https://vuldb.com/vuln/390453)
  - [CVE-2026-72044 | Linux Kernel up to 7.2-rc2 ksmbd ksmbd_decode_ntlmssp_auth_blob stack-based overflow](https://vuldb.com/vuln/390423)
  - [CVE-2026-72045 | Linux Kernel up to 6.6.147/6.12.100/6.18.41/7.1.4 octeontx2-af rvu_mbox_handler_lmtst_tbl_setup/is_pf_func_valid base_pcifunc/FUNC privileges management](https://vuldb.com/vuln/390464)
  - [CVE-2026-72046 | Linux Kernel up to 6.12.100/6.18.39/7.1.4 gve gve_rx_post_buffers_dqo tail/head buffer overflow](https://vuldb.com/vuln/390448)
  - [CVE-2026-72047 | Linux Kernel up to 7.1.4 ieee802154/ca8210 code injection](https://vuldb.com/vuln/390466)
  - [CVE-2026-72048 | Linux Kernel up to 7.1.4 ieee802154 ca8210_spi_transfer allocation of resources](https://vuldb.com/vuln/390462)
  - [CVE-2026-72049 | Linux Kernel up to 7.1.4 ieee802154 net/ieee802154/netlink.c IEEE802154_DUMP information disclosure](https://vuldb.com/vuln/390465)
  - [CVE-2026-72050 | Linux Kernel up to 6.12.96/6.18.39/7.1.4 octeontx2-af nix_setup_bpids allocation of resources](https://vuldb.com/vuln/390463)
  - [CVE-2026-72051 | Linux Kernel up to 6.6.147/6.12.100/6.18.39/7.1.4 ip6_tunnel ip6_tnl_changelink privileges management](https://vuldb.com/vuln/390454)
  - [CVE-2026-72052 | Linux Kernel up to 7.1.4 ip6_gre ip6gre_changelink/ip6erspan_changelink privileges management](https://vuldb.com/vuln/390455)
  - [CVE-2026-72053 | Linux Kernel up to 7.1.4 ipip ipip_changelink privileges management](https://vuldb.com/vuln/390456)
  - [CVE-2026-72054 | Linux Kernel up to 7.1.4 ip_vti vti_changelink privileges management](https://vuldb.com/vuln/390457)
  - [CVE-2026-72055 | Linux Kernel up to 7.1.4 ip6_vti vti6_changelink privileges management](https://vuldb.com/vuln/390458)
  - [CVE-2026-72085 | Linux Kernel up to 7.2-rc3 scsiback scsiback_do_cmd_fn use after free](https://vuldb.com/vuln/390424)
  - [CVE-2026-72086 | Linux Kernel up to 7.2-rc3 scsiback scsiback_device_action double free](https://vuldb.com/vuln/390425)
  - [CVE-2026-72088 | Linux Kernel up to 7.2-rc3 hpsa in_reset memory leak](https://vuldb.com/vuln/390468)
  - [CVE-2026-72108 | Linux Kernel up to 7.2-rc2 dm thin metadata __reserve_metadata_snap/__release_metadata_snap reference count](https://vuldb.com/vuln/390469)
  - [CVE-2026-72131 | Linux Kernel up to 6.18.39/7.1.4 nvme-apple denial of service](https://vuldb.com/vuln/390422)
  - [CVE-2026-72138 | Linux Kernel up to 7.2-rc1 gntdev drivers/xen/gntdev.c gntdev_ioctl_map_grant_ref memory leak](https://vuldb.com/vuln/390426)
  - [CVE-2026-72144 | Linux Kernel up to 6.6.147/6.12.96/6.18.39/7.1.4 dell-laptop dell_init initialization](https://vuldb.com/vuln/390470)
  - [CVE-2026-72151 | Linux Kernel up to 6.12.96/6.18.39/7.1.4 TPM tpm2-sessions.c tpm_buf_append_salt use after free](https://vuldb.com/vuln/390467)
  - [CVE-2026-72193 | Linux Kernel up to 7.1.4 ntfs3 check_rstbl infinite loop](https://vuldb.com/vuln/390427)
  - [CVE-2026-72197 | Linux Kernel up to 7.1.4 NTFS3 fslog.c do_action size/used/total buffer overflow](https://vuldb.com/vuln/390428)
  - [CVE-2026-72222 | Linux Kernel up to 6.6.144/6.12.96/6.18.39/7.1.4 sunrpc svc_tcp_handshake use after free](https://vuldb.com/vuln/390431)
...
- 不安全
  ...
  - [Impacket for Pentester: SMBExec](https://buaq.net/go-435311.html)
