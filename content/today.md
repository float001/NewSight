...
- 2Libra
  ...
  - [这几天是我 B 站会员最值的时候](https://2libra.com/post/animation-sharing/jLFyr93)
...
- VulDB Recent Entries
  ...
  - [CVE-2026-10254 | SourceCodester Pet Grooming Management Software 1.0 /admin/ file information disclosure](https://vuldb.com/vuln/367532)
  - [CVE-2026-10255 | SourceCodester Pharmacy Sales and Inventory System 1.0 ShowForm.php sell_statement access control](https://vuldb.com/vuln/367533)
  - [CVE-2026-10256 | itsourcecode Content Management System 1.0 /save_comment.php Name sql injection](https://vuldb.com/vuln/367536)
  - [CVE-2026-10257 | itsourcecode Content Management System 1.0 /admin/update_ss_img.php topic_id sql injection](https://vuldb.com/vuln/367537)
  - [CVE-2026-10258 | itsourcecode Content Management System 1.0 /admin/add_sub_topic.php topic_id sql injection](https://vuldb.com/vuln/367538)
  - [CVE-2026-10259 | H3C Magic B0 up to 100R002 /goform/aspForm SetMobileAPInfoById param stack-based overflow](https://vuldb.com/vuln/367539)
  - [CVE-2026-10260 | CodeAstro Online Job Portal 1.0 delete-jobs.php ID sql injection](https://vuldb.com/vuln/367540)
  - [CVE-2026-10261 | CodeAstro Online Job Portal 1.0 application_status.php ID sql injection](https://vuldb.com/vuln/367541)
  - [CVE-2026-10262 | code-projects Real State Services 1.0 Login /loginuser.php Username sql injection](https://vuldb.com/vuln/367542)
  - [CVE-2026-10263 | SourceCodester Computer Repair Shop Management System up to 1.0 manage_product.php ID sql injection](https://vuldb.com/vuln/367543)
  - [CVE-2026-10264 | lharries whatsapp-mcp 0.0.1 Send API Endpoint whatsapp-bridge/main.go SendMessageRequest mediaPath path traversal (Issue 241)](https://vuldb.com/vuln/367544)
  - [CVE-2026-10265 | itsourcecode Content Management System 1.0 /admin/edit_topic.php topic_id sql injection](https://vuldb.com/vuln/367545)
  - [CVE-2026-10267 | janet-lang janet up to 1.41.0 src/core/debug.c doframe out-of-bounds (Issue 1743)](https://vuldb.com/vuln/367546)
  - [CVE-2026-10268 | janet-lang janet up to 1.41.0 src/core/marsh.c unmarshal_one_fiber integer overflow (Issue 1744)](https://vuldb.com/vuln/367547)
  - [CVE-2026-10269 | decolua 9router up to 0.4.0 HTTP Header src/dashboardGuard.js isAuthenticated Host improper authorization (Issue 742)](https://vuldb.com/vuln/367548)
  - [CVE-2026-10270 | D-Link DI-7001 MINI up to 19.09.19A1 API /httpd_debug.asp sprintf Time stack-based overflow](https://vuldb.com/vuln/367549)
  - [CVE-2026-10271 | a4m4 Student-Management-System up to f0c5f6842c5e8c431ff02b5260a565ca844df3a0 Admin Endpoint admin/ uid redirect](https://vuldb.com/vuln/367550)
  - [CVE-2026-10272 | a4m4 Student-Management-System up to f0c5f6842c5e8c431ff02b5260a565ca844df3a0 admin/deleteform.php sid improper authorization](https://vuldb.com/vuln/367551)
  - [CVE-2026-10273 | php-censor up to 2.1.6 Webhook Endpoint GitBuild.php commitId os command injection (Issue 442)](https://vuldb.com/vuln/367552)
  - [CVE-2026-10274 | indrasishbanerjee aem-mcp-server up to b5f833aef9b5dfd17a5991b3b18a8a11edbdc583 Axios Request Flow src/mcp-server.ts getAssetMetadata assetPath server-side request forgery](https://vuldb.com/vuln/367553)
  - [CVE-2026-40861 | Apache Airflow up to 3.2.1 FileTaskHandler symlink](https://vuldb.com/vuln/367554)
  - [CVE-2026-40961 | Apache Airflow up to 3.2.1 redirect](https://vuldb.com/vuln/367555)
  - [CVE-2026-40963 | Apache Airflow up to 3.2.1 structure_data authorization](https://vuldb.com/vuln/367556)
  - [CVE-2026-41014 | Apache Airflow up to 3.2.1 partitioned_dag_runs Endpoint /ui/partitioned_dag_runs access control](https://vuldb.com/vuln/367557)
  - [CVE-2026-41017 | Apache Airflow up to 3.2.1 JWTRefreshMiddleware missing secure attribute](https://vuldb.com/vuln/367558)
  - [CVE-2026-41084 | Apache Airflow up to 3.2.1 TaskInstances authorization](https://vuldb.com/vuln/367559)
  - [CVE-2026-42252 | Apache Airflow up to 3.2.1 BashOperator dag_run.conf special elements used in a template engine](https://vuldb.com/vuln/367560)
  - [CVE-2026-42358 | Apache Airflow up to 3.2.1 missing encryption](https://vuldb.com/vuln/367561)
  - [CVE-2026-42359 | Apache Airflow up to 3.2.1 XCom PATCH Endpoint](https://vuldb.com/vuln/367562)
  - [CVE-2026-42360 | Apache Airflow up to 3.2.1 information disclosure](https://vuldb.com/vuln/367563)
  - [CVE-2026-45360 | Apache Airflow up to 3.2.1 Import deserialization](https://vuldb.com/vuln/367564)
  - [CVE-2026-45426 | Apache Airflow up to 3.2.1 JWT lstrip authorization](https://vuldb.com/vuln/367565)
  - [CVE-2026-46764 | Apache Airflow up to 3.2.1 Event Log Detail Endpoint permission](https://vuldb.com/vuln/367566)
  - [CVE-2026-48726 | Apache Airflow up to 3.2.1 FabAuthManager/KeycloakAuthManager revoke_token access control](https://vuldb.com/vuln/367567)
  - [CVE-2026-49489 | OpenCATS up to 0.9.7.4 DataGrid getDataGridPager.php ajax sortDirection sql injection](https://vuldb.com/vuln/367534)
  - [CVE-2026-49490 | OpenCATS up to 0.9.1a DataGrid Filter sql injection](https://vuldb.com/vuln/367535)
- Vulners.com RSS Feed
  ...
  - [CVE-2026-10182](https://vulners.com/nvd/NVD:CVE-2026-10182?utm_source=rss&utm_medium=rss&utm_campaign=rss)
  - [CVE-2026-10183](https://vulners.com/nvd/NVD:CVE-2026-10183?utm_source=rss&utm_medium=rss&utm_campaign=rss)
  ...
  - [CVE-2026-10184](https://vulners.com/nvd/NVD:CVE-2026-10184?utm_source=rss&utm_medium=rss&utm_campaign=rss)
  - [CVE-2026-10185](https://vulners.com/nvd/NVD:CVE-2026-10185?utm_source=rss&utm_medium=rss&utm_campaign=rss)
  - [CVE-2026-10186](https://vulners.com/nvd/NVD:CVE-2026-10186?utm_source=rss&utm_medium=rss&utm_campaign=rss)
  ...
  - [Dutch Authorities Dismantle Botnet Linked to 17 Million Infected Devices](https://vulners.com/thn/THN:CCBAEA4196DBC082BB67891C52B61960?utm_source=rss&utm_medium=rss&utm_campaign=rss)
